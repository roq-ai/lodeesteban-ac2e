...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`LodeEsteban`}</title>

        <meta
          name="description"
          content="Welcome to LodeEsteban - Revolutionizing the restaurant industry by seamlessly managing table reservations and menus while providing customers with an effortless reservation experience."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to LodeEsteban - Revolutionizing the restaurant industry by seamlessly managing table reservations and menus while providing customers with an effortless reservation experience.`}
            </Text>
            <Box
