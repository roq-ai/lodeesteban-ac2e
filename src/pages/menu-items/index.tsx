...
import { useRoqClient, useMenuItemFindManyWithCount } from 'lib/roq';
...
export function MenuItemListPage(props: MenuItemListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useMenuItemFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.menu_item.delete({ where: { id } });
      await mutate();
    } catch (error) {
