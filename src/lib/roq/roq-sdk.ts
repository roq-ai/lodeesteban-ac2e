...
import type { Prisma, employee, menu_item, reservation, restaurant, table, user } from './types';
...
interface Menu_itemSDK {
  create: <T extends Prisma.menu_itemCreateArgs, R extends CheckSelect<T, menu_item, Prisma.menu_itemGetPayload<T>>>(
    data: Prisma.SelectSubset<T, Prisma.menu_itemCreateArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  createMany: <T extends Prisma.menu_itemCreateManyArgs, R extends Prisma.BatchPayload>(
    args: Prisma.SelectSubset<T, Prisma.menu_itemCreateManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  update: <T extends Prisma.menu_itemUpdateArgs, R extends Prisma.menu_itemGetPayload<T>>(
    data: Prisma.SelectSubset<T, Prisma.menu_itemUpdateArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  updateMany: <T extends Prisma.menu_itemUpdateManyArgs, R extends Prisma.BatchPayload>(
    args: Prisma.SelectSubset<T, Prisma.menu_itemUpdateManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  upsert: <T extends Prisma.menu_itemUpsertArgs, R extends Prisma.menu_itemGetPayload<T>>(
    data: Prisma.SelectSubset<T, Prisma.menu_itemUpsertArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  delete: <T extends Prisma.menu_itemDeleteArgs, R extends Prisma.menu_itemGetPayload<T>>(
    data: Prisma.SelectSubset<T, Prisma.menu_itemDeleteArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  deleteMany: <T extends Prisma.menu_itemDeleteManyArgs, R extends Prisma.BatchPayload>(
    args: Prisma.SelectSubset<T, Prisma.menu_itemDeleteManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  findMany: <
    T extends Prisma.menu_itemFindManyArgs,
    R extends GetFindResult<Prisma.$menu_itemPayload<DefaultArgs>, T>[],
  >(
    args: Prisma.SelectSubset<T, Prisma.menu_itemFindManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  count: <T extends Prisma.menu_itemCountArgs, R extends number>(
    args: Prisma.SelectSubset<T, Prisma.menu_itemCountArgs>,
    options?: RequestOptions,
  ) => Promise<R>;
  ...
  findFirst: <
    T extends Prisma.menu_itemFindFirstArgs,
    R extends GetFindResult<Prisma.$menu_itemPayload<DefaultArgs>, T>,
  >(
    args?: Prisma.SelectSubset<T, Prisma.menu_itemFindFirstArgs>,
    options?: RequestOptions,
  ) => Promise<R>;
}
...
export class RoqClient extends RoqPlatformClient {
  ...
  private initSDK() {
    ...
    this.menu_item = {
      create: async function createMenu_item<
        T extends Prisma.menu_itemCreateArgs,
        R extends CheckSelect<T, menu_item, Prisma.menu_itemGetPayload<T>>,
      >(data: Prisma.SelectSubset<T, Prisma.menu_itemCreateArgs>, options?: RequestOptions) {
        const response = await fetcher<R, true>(
          `${ctx.endpoint}/api/model/menu_item/create`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'POST',
      ...
      createMany: async function createManyMenu_item<
        T extends Prisma.menu_itemCreateManyArgs,
        R extends Prisma.BatchPayload,
      >(data: Prisma.SelectSubset<T, Prisma.menu_itemCreateManyArgs>, options?: RequestOptions) {
        const response = await fetcher<R, false>(
          `${ctx.endpoint}/api/model/menu_item/createMany`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'POST',
      ...
      update: async function updateMenu_item<
        T extends Prisma.menu_itemUpdateArgs,
        R extends Prisma.menu_itemGetPayload<T>,
      >(data: Prisma.SelectSubset<T, Prisma.menu_itemUpdateArgs>, options?: RequestOptions) {
        const response = await fetcher<R, true>(
          `${ctx.endpoint}/api/model/menu_item/update`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'PUT',
      ...
      updateMany: async function updateManyMenu_item<
        T extends Prisma.menu_itemUpdateManyArgs,
        R extends Prisma.BatchPayload,
      >(data: Prisma.SelectSubset<T, Prisma.menu_itemUpdateManyArgs>, options?: RequestOptions) {
        const response = await fetcher<R, false>(
          `${ctx.endpoint}/api/model/menu_item/updateMany`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'PUT',
      ...
      upsert: async function upsertMenu_item<
        T extends Prisma.menu_itemUpsertArgs,
        R extends Prisma.menu_itemGetPayload<T>,
      >(data: Prisma.SelectSubset<T, Prisma.menu_itemUpsertArgs>, options?: RequestOptions) {
        const response = await fetcher<R, true>(
          `${ctx.endpoint}/api/model/menu_item/upsert`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'POST',
      ...
      delete: async function deleteMenu_item<
        T extends Prisma.menu_itemDeleteArgs,
        R extends Prisma.menu_itemGetPayload<T>,
      >(data: Prisma.SelectSubset<T, Prisma.menu_itemDeleteArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/menu_item/delete`;
        const reqUrl = makeUrl(url, data);
        const response = await fetcher<R, true>(
          reqUrl,
          {
      ...
      deleteMany: async function deleteManyMenu_item<
        T extends Prisma.menu_itemDeleteManyArgs,
        R extends Prisma.BatchPayload,
      >(data: Prisma.SelectSubset<T, Prisma.menu_itemDeleteManyArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/menu_item/deleteMany`;
        const reqUrl = makeUrl(url, data);
        const response = await fetcher<R, false>(
          reqUrl,
          {
      ...
      findMany: async function findManyMenu_item<
        T extends Prisma.menu_itemFindManyArgs,
        R extends GetFindResult<Prisma.$menu_itemPayload<DefaultArgs>, T>[],
      >(args: Prisma.SelectSubset<T, Prisma.menu_itemFindManyArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/menu_item/findMany`;
        const urlWithArgs = makeUrl(url, args);
        const response = await fetcher<R, false>(
          urlWithArgs,
          {
      ...
      count: async function countMenu_item<T extends Prisma.menu_itemCountArgs, R extends number>(
        args: Prisma.SelectSubset<T, Prisma.menu_itemCountArgs>,
        options?: RequestOptions,
      ) {
        const url = `${ctx.endpoint}/api/model/menu_item/count`;
        const urlWithArgs = makeUrl(url, args);
        const response = await fetcher<R, false>(
          urlWithArgs,
          {
      ...
      findManyWithCount: async function findManyWithCountMenu_item<
        T extends Prisma.menu_itemFindManyArgs,
        R extends GetFindResult<Prisma.$menu_itemPayload<DefaultArgs>, T>[],
        C extends number,
      >(args: Prisma.SelectSubset<T, Prisma.menu_itemFindManyArgs>, options?: RequestOptions) {
        const { distinct, orderBy, where } = args || {};
        const [data, count] = await Promise.all([
          ctx.menu_item.findMany(args, options),
          ctx.menu_item.count(
            {
              orderBy,
              where,
      ...
      findFirst: async function findFirstMenu_item<
        T extends Prisma.menu_itemFindFirstArgs,
        R extends GetFindResult<Prisma.$menu_itemPayload<DefaultArgs>, T>,
      >(args?: Prisma.SelectSubset<T, Prisma.menu_itemFindFirstArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/menu_item/findFirst`;
        const urlWithArgs = makeUrl(url, args);
        const response = await fetcher<R, false>(
          urlWithArgs,
          {
