...
export function useMenuItemFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useMenuItemFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.menu_item.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useMenuItemCount<T extends Prisma.menu_itemCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.menu_itemCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useMenuItemCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.menu_item.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useMenuItemFindManyWithCount<
  T extends Prisma.menu_itemFindManyArgs,
  R extends { data: GetFindResult<Prisma.$menu_itemPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.menu_itemFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useMenuItemFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.menu_item.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useMenuItemFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useMenuItemFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.menu_item.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
